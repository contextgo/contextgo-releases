...
<div className='editorial-note'>
  ...
  <p>Release architecture is not an internal detail from the user's perspective. It is a trust question: which version is real, where to download it, and whether the updater matches the website.</p>
</div>
